...
class ECGDataset(Dataset):
    def __init__(self, data_path, csv_file, mode='train', dataset_name='ptbxl', backbone='mmlformer_vit_tiny'):
...
def getdataset(data_path, csv_path, mode='train', dataset_name='ptbxl', ratio=100, backbone='mmlformer_vit_tiny'):
    ratio = int(ratio)
